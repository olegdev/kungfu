...
define('references/messages',[],function() {
var module = {exports: {}};
/**
...
Reference.data = [{"id":1,"key":"energy","value":"Энергия"},{"id":2,"key":"rating","value":"Рейтинг"},{"id":3,"key":"all_fights","value":"Всего боев"},{"id":4,"key":"wins","value":"Побед"},{"id":5,"key":"loses","value":"Поражений"},{"id":6,"key":"fights_btn","value":"В бой"},{"id":7,"key":"rating_btn","value":"Рейтинг"},{"id":8,"key":"tournament_btn","value":"Турнир"},{"id":9,"key":"window_title_search","value":"Поиск противника"},{"id":10,"key":"main_title","value":"Интеллектуальный бокс"},{"id":11,"key":"dictionary_loading_hint","value":"Загрузка словаря.."},{"id":12,"key":"msg_not_active_battle","value":"Бой не активен"},{"id":13,"key":"msg_battle_not_found","value":"Бой не найден"},{"id":14,"key":"msg_invalid_params","value":"Неверные параметры"},{"id":15,"key":"msg_word_not_found","value":"Такого слова нет в словаре"},{"id":16,"key":"window_title_battle_resul_win","value":"Победа!"},{"id":17,"key":"window_title_battle_resul_lose","value":"Поражение.."}];
module.exports = Reference;
return module.exports; });
define('references/hints',['underscore'],function() {
var module = {exports: {}};
/**
...
define('text!location/templates/views/window.tpl',[],function () { return '<div class="window-title"><%= title %></div>\r\n<div class="window-close">x</div>\r\n<div class="window-content"><%= content %></div>';});

/*** Всплывающее окошко */
define('location/views/window',[
	'jquery',
	'underscore',
	'backbone',
...
define('text!location/templates/views/user_avatar.tpl',[],function () { return '<div class="user-avatar <%= align %> <%= !user ? "empty" : "" %>">\r\n<img src="<%= !user ? "img/panda_50_50.png" : user.info.img %>"/>\r\n<% if (user) { %>\r\n<span><%= user.info.title.replace(/\\s+/g,\'<br/>\') %></span>\r\n<% } else { %>\r\n<span class="loading"></span>\r\n<% } %>\r\n</div>';});

/*** Аватарка юзера */
define('location/views/user_avatar',[
	'jquery',
	'underscore',
	'backbone',
...
define('text!location/templates/views/opponents.tpl',[],function () { return '<div class="opponents">\r\n\t<%= avatarView.print(user) %>\r\n\t<div class="vs-sign">VS</div>\r\n\t<%= avatarView.print(enemy, \'rtl enemy-avatar\') %>\r\n</div>';});

/*** Отображает панель с противниками */
define('location/views/opponents',[
	'jquery',
	'underscore',
	'backbone',
...
define('text!battle_search/templates/search_window.tpl',[],function () { return '<div id="battle-search-window">\r\n<%= opponentsView.print(user) %>\r\n<div class="hints">...</div>\r\n</div>';});

/*** Окно поиска противника */
define('battle_search/views/search_window',[
	'jquery',
	'underscore',
	'backbone',
 ...
 *
 */
define('battle_search/battle_search',[
	'jquery',
	'underscore',
	'backbone',
...
define('text!location/templates/views/controls.tpl',[],function () { return '<ul>\r\n<li><button type="button" id="fight-btn"><%= messages.getByKey("fights_btn") %></button></li>\r\n<li><button type="button" id="tournament-btn"><%= messages.getByKey("tournament_btn") %></button></li>\r\n<li><button type="button" id="rating-btn"><%= messages.getByKey("rating_btn") %></button></li>\r\n</ul>';});

/*** Кнопки управления основного экрана */
define('location/views/controls',[
	'jquery',
	'underscore',
	'backbone',
...
define('text!location/templates/main.tpl',[],function () { return '<div id="s1">READY?</div>\r\n<div id="s2">FIGHT!</div>\r\n<div id="location">\r\n\t<div class="location-title"><%= messages.getByKey("main_title") %></div>\r\n\t<div class="location-content">\r\n\t\t<div id="infoview-box"></div>\r\n\t\t<div id="controlsview-box"></div>\r\n\t</div>\r\n</div>\r\n';});
...
define('references/sounds',[],function() {
var module = {exports: {}};
/**
 * Справочник клиентских сообщений
 *
...
Reference.data = [{"id":1,"key":"hit_1","value":"audio/hit_1.mp3","loop":""},{"id":2,"key":"hit_2","value":"audio/hit_2.mp3","loop":""},{"id":3,"key":"click","value":"audio/click.mp3"},{"id":7,"key":"song1","value":"audio/song1.mp3","loop":1},{"id":8,"key":"hit_3","value":"audio/hit_3.mp3","loop":""},{"id":9,"key":"hit_finished","value":"audio/crash.mp3"},{"id":10,"key":"win","value":"audio/win.wav"}];
module.exports = Reference;
return module.exports; });
/**
 * Модуль звуков.
...
define('text!battle/templates/battle_container.tpl',[],function () { return '<div id="battle">\r\n\t<div id="battle-side2">\r\n\t</div>\r\n\t<%= opponents %>\r\n\t<div id="battle-side1">\r\n\t</div>\r\n</div>';});

/*** Окно перед боем */
define('battle/views/battle_container',[
	'jquery',
	'underscore',
	'backbone',
	'sound/sound',
...
define('text!battle/templates/battle_result_window.tpl',[],function () { return '<div id="battle-result-window">\r\n<%= opponentsView.print(user, enemy) %>\r\n</div>';});

/*** Окно результатов */
define('battle/views/battle_result_window',[
	'jquery',
	'underscore',
	'backbone',
